...
def args_parser():
    ...
    # focal loss
    parser.add_argument("--alpha", type=float, default=0.999, help='the alpha parameter of focal loss')
    parser.add_argument("--gamma", type=float, default=2, help='the gamma parameter of focal loss')
    parser.add_argument("--reduce", action="store_const", const=True, default=False, help='use mean operation on focal loss')
